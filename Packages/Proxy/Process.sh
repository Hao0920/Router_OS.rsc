...
# 删除空格行
sed -e '/^$/d' ./Cache/Proxy/Process/Loyalsoldier/2.txt > ./Cache/Proxy/Process/Loyalsoldier/3.txt
# 去重
sort -u ./Cache/Proxy/Process/Loyalsoldier/3.txt > ./Cache/Proxy/Process/Loyalsoldier/geoip.txt
