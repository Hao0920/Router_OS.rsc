...
sed -e '/regexp:/d' ./Cache/Direct/Process/v2fly/3.txt > ./Cache/Direct/Process/v2fly/4.txt
sed -e 's/full://' ./Cache/Direct/Process/v2fly/4.txt > ./Cache/Direct/Process/v2fly/5.txt
sed -e 's/ @cn//' ./Cache/Direct/Process/v2fly/5.txt > ./Cache/Direct/Process/v2fly/domain-list-community.txt
{
