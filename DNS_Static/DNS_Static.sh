...
uniq ./DNS_Static/Cache/alexa.txt
# 苹果
...
uniq ./DNS_Static/Cache/apple.txt
# 华为
...
uniq ./DNS_Static/Cache/huawei.txt
# Roku
...
uniq ./DNS_Static/Cache/roku.txt
# 三星
...
uniq ./DNS_Static/Cache/samsung.txt
# Sonos
...
uniq ./DNS_Static/Cache/sonos.txt
# Windows
...
uniq ./DNS_Static/Cache/windows.txt
# 小米
...
uniq ./DNS_Static/Cache/xiaomi.txt
