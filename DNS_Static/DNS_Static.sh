...
sed -i '/^#/d;/^$/d' | sort | uniq ./DNS_Static/Cache/alexa.txt
# 苹果
...
sed -i '/^#/d;/^$/d' | sort | uniq ./DNS_Static/Cache/apple.txt
# 华为
...
sed -i '/^#/d;/^$/d' | sort | uniq ./DNS_Static/Cache/huawei.txt
# Roku
...
sed -i '/^#/d;/^$/d' | sort | uniq ./DNS_Static/Cache/roku.txt
# 三星
...
sed -i '/^#/d;/^$/d' | sort | uniq ./DNS_Static/Cache/samsung.txt
# Sonos
...
sed -i '/^#/d;/^$/d' | sort | uniq ./DNS_Static/Cache/sonos.txt
# Windows
...
sed -i '/^#/d;/^$/d' | sort | uniq ./DNS_Static/Cache/windows.txt
# 小米
...
sed -i '/^#/d;/^$/d' | sort | uniq ./DNS_Static/Cache/xiaomi.txt
