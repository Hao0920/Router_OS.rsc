...
sed -i -e '/#/d;/^$/d'  | sort | uniq >./DNS_Static/Cache/alexa.txt
...
sed -i -e '/#/d;/^$/d'  | sort | uniq >./DNS_Static/Cache/apple.txt
# 华为
...
sed -i -e '/#/d;/^$/d'  | sort | uniq >./DNS_Static/Cache/huawei.txt
# Roku
...
sed -i -e '/#/d;/^$/d'  | sort | uniq >./DNS_Static/Cache/roku.txt
# 三星
...
sed -i -e '/#/d;/^$/d'  | sort | uniq >./DNS_Static/Cache/samsung.txt
# Sonos
...
sed -i -e '/#/d;/^$/d'  | sort | uniq >./DNS_Static/Cache/sonos.txt
# Windows
...
sed -i -e '/#/d;/^$/d'  | sort | uniq >./DNS_Static/Cache/windows.txt
# 小米
...
sed -i -e '/#/d;/^$/d'  | sort | uniq >./DNS_Static/Cache/xiaomi.txt
#构建 DNS Static
{
echo "/ip dns static"
