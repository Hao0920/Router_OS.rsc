...
sort ./DNS_Static/Cache/alexa.txt | uniq
# 苹果
...
sort ./DNS_Static/Cache/apple.txt | uniq
# 华为
...
sort ./DNS_Static/Cache/huawei.txt | uniq
# Roku
...
sort ./DNS_Static/Cache/roku.txt | uniq
# 三星
...
sort ./DNS_Static/Cache/samsung.txt | uniq
# Sonos
...
sort ./DNS_Static/Cache/sonos.txt | uniq
# Windows
...
sort ./DNS_Static/Cache/windows.txt | uniq
# 小米
...
sort ./DNS_Static/Cache/xiaomi.txt | uniq
