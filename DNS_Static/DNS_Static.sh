...
sed -i '/#/d;/^$/d' ./DNS_Static/Cache/alexa.txt
cat ./DNS_Static/Cache/alexa.txt | sort | uniq > ./DNS_Static/Cache/alexa.txt
# 苹果
...
sed -i '/#/d;/^$/d' ./DNS_Static/Cache/apple.txt
cat ./DNS_Static/Cache/apple.txt | sort | uniq > ./DNS_Static/Cache/apple.txt
# 华为
...
sed -i '/#/d;/^$/d' ./DNS_Static/Cache/huawei.txt
cat ./DNS_Static/Cache/huawei.txt | sort | uniq > ./DNS_Static/Cache/huawei.txt
# Roku
...
sed -i '/#/d;/^$/d' ./DNS_Static/Cache/roku.txt
cat ./DNS_Static/Cache/roku.txt | sort | uniq > ./DNS_Static/Cache/roku.txt
# 三星
...
sed -i '/#/d;/^$/d' ./DNS_Static/Cache/samsung.txt
cat ./DNS_Static/Cache/samsung.txt | sort | uniq > ./DNS_Static/Cache/samsung.txt
# Sonos
...
sed -i '/#/d;/^$/d' ./DNS_Static/Cache/sonos.txt
cat ./DNS_Static/Cache/sonos.txt | sort | uniq > ./DNS_Static/Cache/sonos.txt
# Windows
...
sed -i '/#/d;/^$/d' ./DNS_Static/Cache/windows.txt
cat ./DNS_Static/Cache/windows.txt | sort | uniq > ./DNS_Static/Cache/windows.txt
# 小米
...
sed -i '/#/d;/^$/d' ./DNS_Static/Cache/xiaomi.txt
cat ./DNS_Static/Cache/xiaomi.txt | sort | uniq > ./DNS_Static/Cache/xiaomi.txt
