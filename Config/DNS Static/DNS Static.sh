...
sort ./Config/DNS_Static/Cache/alexa2.txt -u > ./Config/DNS_Static/Cache/alexa.txt
sed -e '/^#/d' ./Config/DNS_Static/Cache/apple1.txt > ./Config/DNS_Static/Cache/apple2.txt
sort ./Config/DNS_Static/Cache/apple2.txt -u > ./Config/DNS_Static/Cache/apple.txt
sed -e '/^#/d' ./Config/DNS_Static/Cache/huawei1.txt > ./Config/DNS_Static/Cache/huawei2.txt
sort ./Config/DNS_Static/Cache/huawei2.txt -u > ./Config/DNS_Static/Cache/huawei.txt
sed -e '/^#/d' ./Config/DNS_Static/Cache/roku1.txt > ./Config/DNS_Static/Cache/roku2.txt
sort ./Config/DNS_Static/Cache/roku2.txt -u > ./Config/DNS_Static/Cache/roku.txt
sed -e '/^#/d' ./Config/DNS_Static/Cache/samsung1.txt > ./Config/DNS_Static/Cache/samsung2.txt
sort ./Config/DNS_Static/Cache/samsung2.txt -u > ./Config/DNS_Static/Cache/samsung.txt
sed -e '/^#/d' ./Config/DNS_Static/Cache/sonos1.txt > ./Config/DNS_Static/Cache/sonos2.txt
sort ./Config/DNS_Static/Cache/sonos2.txt -u > ./Config/DNS_Static/Cache/sonos.txt
sed -e '/^#/d' ./Config/DNS_Static/Cache/windows1.txt > ./Config/DNS_Static/Cache/windows2.txt
sort ./Config/DNS_Static/Cache/windows2.txt -u > ./Config/DNS_Static/Cache/windows.txt
sed -e '/^#/d' ./Config/DNS_Static/Cache/xiaomi1.txt > ./Config/DNS_Static/Cache/xiaomi2.txt
sort ./Config/DNS_Static/Cache/xiaomi2.txt -u > ./Config/DNS_Static/Cache/xiaomi.txt

### 构建 ###
{
  echo "/ip dns static"
  echo "remove [find address=240.0.0.1]"
  for name in $(cat ./Config/DNS_Static/Cache/alexa.txt) ; do
    echo "add address=240.0.0.1 name=$name"
  done
  for name in $(cat ./Config/DNS_Static/Cache/apple.txt) ; do
    echo "add address=240.0.0.1 name=$name"
  done
  for name in $(cat ./Config/DNS_Static/Cache/huawei.txt) ; do
    echo "add address=240.0.0.1 name=$name"
  done
  for name in $(cat ./Config/DNS_Static/Cache/roku.txt) ; do
    echo "add address=240.0.0.1 name=$name"
  done
  for name in $(cat ./Config/DNS_Static/Cache/samsung.txt) ; do
    echo "add address=240.0.0.1 name=$name"
  done
  for name in $(cat ./Config/DNS_Static/Cache/sonos.txt) ; do
    echo "add address=240.0.0.1 name=$name"
  done
  for name in $(cat ./Config/DNS_Static/Cache/windows.txt) ; do
    echo "add address=240.0.0.1 name=$name"
  done
  for name in $(cat ./Config/DNS_Static/Cache/xiaomi.txt) ; do
    echo "add address=240.0.0.1 name=$name"
  done
